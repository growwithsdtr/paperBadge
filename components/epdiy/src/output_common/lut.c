 ...
 *
 * The Paper S3 build uses the ESP32-S3 vector assembly implementation
 * in lut.S. Keep only the declaration here so the C fallback does not
 * define a duplicate weak-looking hot-path symbol.
 */
extern void calc_epd_input_1ppB_1k_S3_VE_aligned(
